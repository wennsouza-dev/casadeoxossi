...
const MemberDonations: React.FC = () => {
    ...
    const [pledgeInputs, setPledgeInputs] = useState<{ [key: string]: string }>({}); // Stores input value per item
                ...
                <div className="max-w-5xl mx-auto space-y-8">
                    ...
                    {loading ? (
                        ...
                        <div className="text-center py-20 bg-white dark:bg-surface-dark rounded-3xl border border-dashed border-gray-200 dark:border-white/10">
                            ...
                            <p className="text-gray-500">Nenhum pedido de doação ativo no momento.</p>
                        </div>
                    ) : (
                                        ...
                                        <div className="flex justify-between items-start mb-4">
                                            <div className="p-3 rounded-xl bg-primary/10 text-primary">
                                                <span className="material-symbols-outlined">
                                                    {isFull ? 'check_circle' : 'volunteer_activism'}
                                                </span>
                                            </div>
